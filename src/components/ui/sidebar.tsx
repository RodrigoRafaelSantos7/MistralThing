/** biome-ignore-all lint/suspicious/noDocumentCookie: This is Shadcn Code TODO: Remove this */
/** biome-ignore-all lint/nursery/noShadow: This is Shadcn Code TODO: Remove this */
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "border-foreground/10 group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l",
          className
        )}
