...
export function ClassicLoader({
  ...
  const transformOriginXValues = {
    sm: "0.75px",
    md: "1px",
    lg: "1.25px",
  };
  const transformOriginYValues = {
    sm: "10px",
    md: "12px",
    lg: "14px",
  };
        ...
        {Array.from({ length: 12 }).map((_, i) => (
          <div
            ...
            style={{
              ...
              transformOrigin: `${transformOriginXValues[size]} ${transformOriginYValues[size]}`,
...
export function DotsLoader({
  ...
  const dotKeys = ["dots-dot-0", "dots-dot-1", "dots-dot-2"];
...
export function TypingLoader({
  ...
  const typingKeys = ["typing-dot-0", "typing-dot-1", "typing-dot-2"];
...
export function BarsLoader({
  ...
  const barsKeys = ["bars-bar-0", "bars-bar-1", "bars-bar-2"];
