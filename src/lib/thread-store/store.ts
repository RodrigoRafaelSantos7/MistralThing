...
export type ThreadStoreImpl<UI_MESSAGE extends UIMessage> = {
  id?: string;
    ...
    devtools(
      subscribeWithSelector((set, get) => {
        const setMessages = (
          ...
          const lastOldMessageId = oldMessageIds.at(-1);
        ...
        return {
          ...
          setStatus: (status: ChatStatus) =>
            set({ status }, false, "thread/setStatus"),
